...
console.log("carattere: ", characterNames);
...
console.log("Solo donne: ", femaleCharacters);
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const character = starWarsCharacters[i];
  const eyeColorValue = character.eye_color;
...
while (i < starWarsCharacters.length) {
  const character = starWarsCharacters[i];
  massaEquipaggio += character.mass;
  i++;
}

console.log("Massa totale equipaggio: ", massaEquipaggio);
...
} else if (totalMass <= 700) {
  console.log("Ship is half loaded");
} else if (totalMass <= 900) {
