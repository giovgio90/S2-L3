...
for (let i = 0; i < starWarsCharacters.length; i++) {
  let ciclStarWars = starWarsCharacters[i];
  characters.push(ciclStarWars.name);
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  let ciclFemale = starWarsCharacters[i];

  if (ciclFemale.gender === "female") {
    femaleCharacters.push(ciclFemale);
  }
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const carattereCorrente = starWarsCharacters[i];

  switch (carattereCorrente.eye_color) {
    case "blue":
      eyeColor.blue.push(carattereCorrente);
      break;
    case "yellow":
      eyeColor.yellow.push(carattereCorrente);
      break;
    case "brown":
      eyeColor.brown.push(carattereCorrente);
    case "red":
      eyeColor.red.push(carattereCorrente);
      break;
    case "blue-gray":
      eyeColor["blue-gray"].push(carattereCorrente);
      break;
    default:
...
while (i < starWarsCharacters.length) {
  cicloMassa = starWarsCharacters[i];
  crewMass = crewMass + cicloMassa.mass;
  i++;
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const currentGender = starWarsCharacters[i];

  if (currentGender.gender === "n/a") {
    currentGender.gender = "robot";
  }
}
...
for (let i = 0; i < characters.length; i++) {
  ...
  for (let j = 0; j < femaleCharacters.length; j++) {
    ...
    console.log(currentFemaleCharacter);
